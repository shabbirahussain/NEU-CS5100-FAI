...
public final class Constants {
	...
	public static final int GHOST_EAT_SCORE = 200; // score for the first ghost
													...
													// single power pill)
	public static final int EDIBLE_TIME = 200; // initial time a ghost is edible
												// for (decreases as level
												// number increases)
	...
	public static final int COMMON_LAIR_TIME = 40; // time spend in lair after
													// being eaten
	...
	public static final float GHOST_REVERSAL = 0.0015f; // probability of a
														...
														// event
	public static final int MAX_TIME = 24000; // maximum time a game can be
												// played for
	...
	public static final int DELAY = 40; // delay (in milliseconds) between game
										// advancements
	public static final int NUM_LIVES = 3; // total number of lives Ms Pac-Man
											// has (current + NUM_LIVES-1
											// spares)
