...
import pacman.controllers.shabbirhussain.*;
...
public class Executor {
	...
	public static void main(String[] args){
		...
		//===============================================================================
		// HW1
		//exec.runGameTimed(new BreadthFirstController(), new RandomGhosts(), visual);
	    //exec.runGameTimed(new DepthFirstController(), new RandomGhosts(), visual);
		//exec.runGameTimed(new DepthFirstIDeepController(), new RandomGhosts(), visual);
		
		// HW2
		//exec.runGameTimed(new AStarController(), new RandomGhosts(), visual);
		//exec.runGameTimed(new HillClimberController(), new RandomGhosts(), visual);
		//exec.runGameTimed(new SimulatedAnnealingController(), new RandomGhosts(), visual);
		
		// HW3
		//exec.runGame(new AlphaBetaController(), new RandomGhosts(), visual, 25 );
		//exec.runGame(new AlphaBetaController(), new RandomGhosts(), visual, 0 );
		//exec.runGame(new EvolutionaryController(), new RandomGhosts(), visual, 50 );
		//exec.runGameTimed(new EvolutionaryController(), new RandomGhosts(), visual);
		
		// HW4
		exec.runGame(new PerceptronController(), new RandomGhosts(), visual, 25 );
		
		
		// ********************************************************************************
		// Final algorithm Local Team Search
		// ********************************************************************************
		//exec.runGame(new SmartController(), new RandomGhosts(), visual, 0 );
